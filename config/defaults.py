...
_C.DATASET = CN()
_C.DATASET.name = "mtc"
_C.DATASET.list_train = "./dataset/train.txt"
_C.DATASET.list_val = "./dataset/val.txt"
_C.DATASET.list_test = "./dataset/test.txt"
...
_C.MODEL.dec_layers = 4
_C.MODEL.pre_norm = False
# _C.MODEL.num_object_queries = 99
_C.MODEL.query_shuffle=False
_C.MODEL.pos_position_embedding = 'v2'
_C.MODEL.que_position_embedding = 'v3'
...
# loss function
_C.TRAIN.counting_loss = "l2loss"
_C.TRAIN.contrast_loss = "none"
